...
@section('content')
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="card-title m-0 me-2 text-secondary">Add Expense</h5>
                    ...
                    <div class="col-md-4">
                        <div class="form-floating form-floating-outline mb-4">
                            <select class="form-select select2" id="expense_member_id" name="expense_member_id"
                                aria-label="Default select example" data-allow-clear="true" data-parsley-errors-container="#expense_member_id_errors"
                                data-placeholder="Select Expense Member" required>
                                <option value="" selected>Select Expense Member</option>
                                @foreach ($expense_members as $expense_member)
                                    <option @if (old('expense_member_id') == $expense_member->id) selected @endif value="{{ $expense_member->id }}">
                                        {{ $expense_member->name }}</option>
                                @endforeach
                            </select>
                            <div id="expense_member_id_errors"></div>
                    ...
                    <div class="col-md-4">
                        <div class="form-floating form-floating-outline mb-4">
                            <select class="form-select select2" id="expense_category_id" name="expense_category_id"
                                aria-label="Default select example" data-allow-clear="true" data-parsley-errors-container="#expense_category_id_errors"
                                data-placeholder="Select Expense Category" required>
                                <option value="" selected>Select Expense Category</option>
                                @foreach ($expense_categories as $expense_category)
                                    <option @if (old('expense_category_id') == $expense_category->id) selected @endif
                                        value="{{ $expense_category->id }}">
                                        {{ $expense_category->name }}</option>
                                @endforeach
                            </select>
                            <div id="expense_category_id_errors"></div>
